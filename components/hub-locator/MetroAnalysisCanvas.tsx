...
export function MetroAnalysisCanvas({ data: initialData, onBack }: Props) {
  ...
  return (
    <div className="print-canvas p-5">
      ...
      {/* Row 1: Scorecard + Demand — kept together, break-inside: avoid in CSS */}
      ...
      {/* Row 2: Map + Controls — flows naturally across pages if needed */}
      ...
      <div className="print-only" style={{ marginTop: '32px', paddingTop: '12px', borderTop: '1px solid #e5e7eb', display: 'flex', justifyContent: 'space-between', fontSize: '9px', color: '#9ca3af' }}>
        ...
        <span>Hub Viability Score v1.0 · {dateStr}</span>
      </div>
    </div>
  )
}
